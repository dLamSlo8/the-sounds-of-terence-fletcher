...
export default function SoundCard({
    ...
    const Handle = SortableHandle(() => (
        <Tippy content={<span className="font-bold text-xs">REORDER</span>}>
            <svg className="w-8 h-8 absolute top-3 left-3 cursor-grab" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <article>
            <div className="c-sound-card relative h-0 pb-[100%] rounded-md bg-white">
                <div className="absolute inset-0 flex flex-col justify-center items-center p-5">
                    ...
                    {
                        inBookmarkSection && !showTranscript && <Handle />
                    }
